...
export default function Header() {
  ...
  return(
    <div className="flex justify-between bg-white p-5 rounded-2xl">
        <div className="flex">
          <img src={search} alt="" className="h-4 w-4 absolute ml-5 mt-5.5" />

          <input type="text" 
                 placeholder= "Search for Xend IDs, names..."
                 className="bg-tertiary-grey h-15 w-98.25 rounded-2xl pl-14" />
        </div>
        ...
        <div className = "flex gap-2">
          ...
          <p className = "font-black text-[1.375rem] text-primary-orange py-2 px-4 rounded-[0.9rem] h-fit bg-tertiary-orange">
            {name[0]}
          </p>
        </div>
    </div>
